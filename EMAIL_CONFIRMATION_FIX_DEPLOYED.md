# Email Confirmation Fix - Deployed & Ready for Verification
...
**File:** `frontend/src/app/api/auth/signup/route.ts` (Lines 63-72)
...
**File:** `frontend/src/app/api/auth/login/route.ts` (Lines 61-124)
...
curl -X POST https://skyras-v2.vercel.app/api/auth/signup \
  ...
  -d '{"email":"test-verify-'$(date +%s)'@example.com","password":"testpass123"}'
```
